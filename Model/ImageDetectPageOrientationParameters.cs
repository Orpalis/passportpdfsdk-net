...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageDetectPageOrientationParameters :  IEquatable<ImageDetectPageOrientationParameters>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="language">Specifies the language(s) to be used for the OCR. (default to &quot;eng&quot;).</param>
        ...
        public ImageDetectPageOrientationParameters(string fileId = default(string), string pageRange = default(string), string language = "eng", bool? automaticallyApplyRotation = true)
        {
            // to ensure "fileId" is required (not null)
            if (fileId == null)
            {
                throw new InvalidDataException("fileId is a required property for ImageDetectPageOrientationParameters and cannot be null");
            }
            else
            {
                this.FileId = fileId;
            ...
            if (pageRange == null)
            {
                throw new InvalidDataException("pageRange is a required property for ImageDetectPageOrientationParameters and cannot be null");
            }
            else
            {
        ...
        /// </summary>
        /// <value>Specifies the language(s) to be used for the OCR.</value>
        ...
        {
            return this.Equals(input as ImageDetectPageOrientationParameters);
        }
