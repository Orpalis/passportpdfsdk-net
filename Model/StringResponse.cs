...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StringResponse :  IEquatable<StringResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        public StringResponse(Error error = default(Error))
        {
            this.Error = error;
        }
        ...
        {
            return this.Equals(input as StringResponse);
        }
