...
namespace PassportPDF.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFProtectResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public PDFProtectResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFProtectResponse {\n");
        ...
        {
            return this.Equals(input as PDFProtectResponse);
        }

        /// <summary>
        /// Returns true if PDFProtectResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFProtectResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFProtectResponse input)
        {
            if (input == null)
                return false;
