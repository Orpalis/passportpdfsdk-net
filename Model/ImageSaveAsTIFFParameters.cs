...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsTIFFParameters :  IEquatable<ImageSaveAsTIFFParameters>
    {
        /// <summary>
        ...
        public ImageSaveAsTIFFParameters(string fileId)
        {
            FileId = fileId;
        }
        ...
        /// </summary>
        [DataMember(Name="UseCMYK")]
        public bool UseCMYK { get; set; } = false;
        ...
        {
            return Equals(input as ImageSaveAsTIFFParameters);
        }
