...
namespace PassportPDF.Model
{
    ...
    public partial class ImageSaveAsTIFFParameters :  IEquatable<ImageSaveAsTIFFParameters>, IValidatableObject
    {
        ...
        public ImageSaveAsTIFFParameters(string fileId = default(string), string pageRange = default(string), CompressionEnum? compression = CompressionEnum.Auto, int? jpegQuality = 75, bool? useCMYK = default(bool?))
        {
            ...
            if (pageRange == null)
            {
                throw new InvalidDataException("pageRange is a required property for ImageSaveAsTIFFParameters and cannot be null");
            }
            else
            {
