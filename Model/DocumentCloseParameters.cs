...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class DocumentCloseParameters :  IEquatable<DocumentCloseParameters>
    {
        /// <summary>
        ...
        public DocumentCloseParameters(string fileId)
        {
            FileId = fileId;
        }
        ...
        {
            return Equals(input as DocumentCloseParameters);
        }
