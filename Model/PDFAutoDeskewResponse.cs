...
namespace PassportPDF.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFAutoDeskewResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public PDFAutoDeskewResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFAutoDeskewResponse {\n");
        ...
        {
            return this.Equals(input as PDFAutoDeskewResponse);
        }

        /// <summary>
        /// Returns true if PDFAutoDeskewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFAutoDeskewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFAutoDeskewResponse input)
        {
            if (input == null)
                return false;
