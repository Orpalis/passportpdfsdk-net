...
namespace PassportPDF.Model
{
    ...
    public partial class PDFReadBarcodesParameters :  IEquatable<PDFReadBarcodesParameters>, IValidatableObject
    {
        ...
        public PDFReadBarcodesParameters(string fileId = default(string), string pageRange = default(string), ScanModeEnum? scanMode = ScanModeEnum.FavorAccuracy, bool? scanBarcode1D = true, bool? scanBarcodeQR = true, bool? scanBarcodeMicroQR = true, bool? scanBarcodePDF417 = true, bool? scanBarcodeDataMatrix = true, bool? scanBarcodeAztec = true)
        {
            ...
            if (pageRange == null)
            {
                throw new InvalidDataException("pageRange is a required property for PDFReadBarcodesParameters and cannot be null");
            }
            else
            {
