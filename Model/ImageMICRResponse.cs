...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageMICRResponse :  IEquatable<ImageMICRResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageMICRResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        /// </summary>
        /// <value>Holds the results of the MICR operations.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageMICRResponse {\n");
        ...
        {
            return this.Equals(input as ImageMICRResponse);
        }
