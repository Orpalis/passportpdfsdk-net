...
namespace PassportPDF.Model
{
    ...
    public partial class PDFSaveAsTIFFParameters :  IEquatable<PDFSaveAsTIFFParameters>, IValidatableObject
    {
        ...
        public PDFSaveAsTIFFParameters(string fileId = default(string), string pageRange = default(string), CompressionEnum? compression = CompressionEnum.Auto, int? jpegQuality = 75, bool? useCMYK = default(bool?), float? resolution = 200.0F, bool? renderFormFields = default(bool?), bool? keepRasterPDFResolution = true)
        {
            ...
            if (pageRange == null)
            {
                throw new InvalidDataException("pageRange is a required property for PDFSaveAsTIFFParameters and cannot be null");
            }
            else
            {
