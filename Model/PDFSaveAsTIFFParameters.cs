...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PdfSaveAsTIFFParameters :  IEquatable<PdfSaveAsTIFFParameters>
    {
        /// <summary>
        ...
        public PdfSaveAsTIFFParameters(string fileId)
        {
            FileId = fileId;
        }
        ...
        {
            return Equals(input as PdfSaveAsTIFFParameters);
        }
