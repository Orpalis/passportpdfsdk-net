...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsPNGResponse :  IEquatable<ImageSaveAsPNGResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageSaveAsPNGResponse" /> class.
        /// </summary>
        public ImageSaveAsPNGResponse()
        {
        }
        ...
        {
            return Equals(input as ImageSaveAsPNGResponse);
        }
