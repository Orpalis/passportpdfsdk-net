...
namespace PassportPDF.Model
{
    ...
    public partial class PDFSaveAsPNGResponse :  IEquatable<PDFSaveAsPNGResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="PageImages">The page(s) of the PDF saved as PNG image(s)..</param>
        ...
        public PDFSaveAsPNGResponse(List<PageImage> PageImages = default(List<PageImage>), Error Error = default(Error), long? RemainingTokens = default(long?))
        {
