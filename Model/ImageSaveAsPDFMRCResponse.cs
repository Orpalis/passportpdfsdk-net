...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsPDFMRCResponse :  IEquatable<ImageSaveAsPDFMRCResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageSaveAsPDFMRCResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageSaveAsPDFMRCResponse {\n");
        ...
        {
            return this.Equals(input as ImageSaveAsPDFMRCResponse);
        }
