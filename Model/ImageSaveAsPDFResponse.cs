...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsPDFResponse :  IEquatable<ImageSaveAsPDFResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageSaveAsPDFResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public ImageSaveAsPDFResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        /// </summary>
        /// <value>Specifies the data of the produced PDF.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageSaveAsPDFResponse {\n");
        ...
        {
            return this.Equals(input as ImageSaveAsPDFResponse);
        }
