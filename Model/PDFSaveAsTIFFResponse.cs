...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PDFSaveAsTIFFResponse :  IEquatable<PDFSaveAsTIFFResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFSaveAsTIFFResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public PDFSaveAsTIFFResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        /// </summary>
        /// <value>The page(s) of the PDF saved as TIFF image(s).</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFSaveAsTIFFResponse {\n");
        ...
        {
            return this.Equals(input as PDFSaveAsTIFFResponse);
        }

        /// <summary>
        /// Returns true if PDFSaveAsTIFFResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFSaveAsTIFFResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFSaveAsTIFFResponse input)
        {
            if (input == null)
                return false;
