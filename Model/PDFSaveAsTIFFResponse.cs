...
namespace PassportPDF.Model
{
    ...
    public partial class PDFSaveAsTIFFResponse :  IEquatable<PDFSaveAsTIFFResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="PageImages">The page(s) of the PDF saved as TIFF image(s)..</param>
        ...
        public PDFSaveAsTIFFResponse(List<PageImage> PageImages = default(List<PageImage>), Error Error = default(Error), long? RemainingTokens = default(long?))
        {
