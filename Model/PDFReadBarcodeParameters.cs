...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PDFReadBarcodeParameters :  IEquatable<PDFReadBarcodeParameters>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFReadBarcodeParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PDFReadBarcodeParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFReadBarcodeParameters" /> class.
        /// </summary>
        ...
        public PDFReadBarcodeParameters(string FileId = default(string), string PageRange = "*", ScanModeEnum? ScanMode = ScanModeEnum.FavorAccuracy, bool? ScanBarcode1D = true, bool? ScanBarcodeQR = true, bool? ScanBarcodeMicroQR = true, bool? ScanBarcodePDF417 = true, bool? ScanBarcodeDataMatrix = true)
        {
            // to ensure "FileId" is required (not null)
            if (FileId == null)
            {
                throw new InvalidDataException("FileId is a required property for PDFReadBarcodeParameters and cannot be null");
            }
            else
            {
                this.FileId = FileId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFReadBarcodeParameters {\n");
        ...
        {
            return this.Equals(input as PDFReadBarcodeParameters);
        }

        /// <summary>
        /// Returns true if PDFReadBarcodeParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFReadBarcodeParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFReadBarcodeParameters input)
        {
            if (input == null)
                return false;
