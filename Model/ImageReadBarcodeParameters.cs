...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageReadBarcodeParameters :  IEquatable<ImageReadBarcodeParameters>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageReadBarcodeParameters" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ImageReadBarcodeParameters() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageReadBarcodeParameters" /> class.
        /// </summary>
        ...
        public ImageReadBarcodeParameters(string FileId = default(string), string PageRange = "*", ScanModeEnum? ScanMode = ScanModeEnum.FavorAccuracy, bool? ScanBarcode1D = true, bool? ScanBarcodeQR = true, bool? ScanBarcodeMicroQR = true, bool? ScanBarcodePDF417 = true, bool? ScanBarcodeDataMatrix = true)
        {
            // to ensure "FileId" is required (not null)
            if (FileId == null)
            {
                throw new InvalidDataException("FileId is a required property for ImageReadBarcodeParameters and cannot be null");
            }
            else
            {
                this.FileId = FileId;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageReadBarcodeParameters {\n");
        ...
        {
            return this.Equals(input as ImageReadBarcodeParameters);
        }

        /// <summary>
        /// Returns true if ImageReadBarcodeParameters instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageReadBarcodeParameters to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageReadBarcodeParameters input)
        {
            if (input == null)
                return false;
