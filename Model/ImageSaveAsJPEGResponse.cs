...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsJPEGResponse :  IEquatable<ImageSaveAsJPEGResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageSaveAsJPEGResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        {
            return this.Equals(input as ImageSaveAsJPEGResponse);
        }
