...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PDFDrawImageResponse :  IEquatable<PDFDrawImageResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public PDFDrawImageResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFDrawImageResponse {\n");
        ...
        {
            return this.Equals(input as PDFDrawImageResponse);
        }
