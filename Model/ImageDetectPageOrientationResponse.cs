...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageDetectPageOrientationResponse :  IEquatable<ImageDetectPageOrientationResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageDetectPageOrientationResponse" /> class.
        /// </summary>
        public ImageDetectPageOrientationResponse()
        {
        }
        ...
        {
            return Equals(input as ImageDetectPageOrientationResponse);
        }
