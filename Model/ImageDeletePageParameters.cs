...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageDeletePageParameters :  IEquatable<ImageDeletePageParameters>
    {
        /// <summary>
        ...
        public ImageDeletePageParameters(string fileId, string pageRange)
        {
            FileId = fileId;
            PageRange = pageRange;
        }
        ...
        {
            return Equals(input as ImageDeletePageParameters);
        }
