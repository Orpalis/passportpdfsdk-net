...
namespace PassportPDF.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFRotatePageStandardResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public PDFRotatePageStandardResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFRotatePageStandardResponse {\n");
        ...
        {
            return this.Equals(input as PDFRotatePageStandardResponse);
        }

        /// <summary>
        /// Returns true if PDFRotatePageStandardResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFRotatePageStandardResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFRotatePageStandardResponse input)
        {
            if (input == null)
                return false;
