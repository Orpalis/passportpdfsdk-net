...
namespace PassportPDF.Model
{
    ...
    public partial class ImageSaveAsTIFFResponse :  IEquatable<ImageSaveAsTIFFResponse>, IValidatableObject
    {
        ...
        /// <param name="PageImages">The image(s) saved as TIFF..</param>
        public ImageSaveAsTIFFResponse(Error Error = default(Error), long? RemainingTokens = default(long?), List<PageImage> PageImages = default(List<PageImage>))
        {
            this.Error = Error;
