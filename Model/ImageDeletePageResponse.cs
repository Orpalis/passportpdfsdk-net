...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageDeletePageResponse :  IEquatable<ImageDeletePageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageDeletePageResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public ImageDeletePageResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        {
            return this.Equals(input as ImageDeletePageResponse);
        }

        /// <summary>
        /// Returns true if ImageDeletePageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ImageDeletePageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImageDeletePageResponse input)
        {
            if (input == null)
                return false;
