...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageGetPageThumbnailResponse :  IEquatable<ImageGetPageThumbnailResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageGetPageThumbnailResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageGetPageThumbnailResponse {\n");
        ...
        {
            return this.Equals(input as ImageGetPageThumbnailResponse);
        }
