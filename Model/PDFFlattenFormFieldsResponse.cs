...
namespace PassportPDF.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PDFFlattenFormFieldsResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="remainingTokens">Specifies the number of remaining tokens..</param>
        public PDFFlattenFormFieldsResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PDFFlattenFormFieldsResponse {\n");
        ...
        {
            return this.Equals(input as PDFFlattenFormFieldsResponse);
        }

        /// <summary>
        /// Returns true if PDFFlattenFormFieldsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PDFFlattenFormFieldsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PDFFlattenFormFieldsResponse input)
        {
            if (input == null)
                return false;
