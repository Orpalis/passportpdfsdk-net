...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSwapPagesParameters :  IEquatable<ImageSwapPagesParameters>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageSwapPagesParameters(string fileId = default(string), int? page1 = default(int?), int? page2 = default(int?))
        {
            // to ensure "fileId" is required (not null)
            if (fileId == null)
            {
                throw new InvalidDataException("fileId is a required property for ImageSwapPagesParameters and cannot be null");
            }
            else
            {
                this.FileId = fileId;
            ...
            if (page1 == null)
            {
                throw new InvalidDataException("page1 is a required property for ImageSwapPagesParameters and cannot be null");
            }
            else
            {
                this.Page1 = page1;
            ...
            if (page2 == null)
            {
                throw new InvalidDataException("page2 is a required property for ImageSwapPagesParameters and cannot be null");
            }
            else
            {
                this.Page2 = page2;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageSwapPagesParameters {\n");
        ...
        {
            return this.Equals(input as ImageSwapPagesParameters);
        }
