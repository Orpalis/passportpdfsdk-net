...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageLoadResponse :  IEquatable<ImageLoadResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public ImageLoadResponse(Error error = default(Error), long? remainingTokens = default(long?))
        {
            this.Error = error;
        ...
        /// </summary>
        /// <value>Specifies the file identifier of the loaded image document.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImageLoadResponse {\n");
        ...
        {
            return this.Equals(input as ImageLoadResponse);
        }
