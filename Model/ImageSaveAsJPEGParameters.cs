...
namespace PassportPDF.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImageSaveAsJPEGParameters :  IEquatable<ImageSaveAsJPEGParameters>
    {
        /// <summary>
        ...
        public ImageSaveAsJPEGParameters(string fileId)
        {
            FileId = fileId;
        }
        ...
        {
            return Equals(input as ImageSaveAsJPEGParameters);
        }
